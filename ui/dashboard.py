diff --git a/ui/dashboard.py b/ui/dashboard.py
index 05144560f82b45c2ebbb9aa5afa784c8603c1690..fde0881c390348c638baafdd33132d8d887cb499 100644
--- a/ui/dashboard.py
+++ b/ui/dashboard.py
@@ -12,79 +12,90 @@ import streamlit as st
...
+def _render_data_grid(df: pd.DataFrame, *, title: str, section_id: str | None, height: int | None = None) -> None:
